...
##Building
Download this version of [bridj-0.7-20140918.jar](https://github.com/chriskearney/eyeballs/blob/master/bridj-0.7-20140918.jar) that properly supports the ARM architecture. (Raspberry Pi).  You will need to install to then install the jar file into your local Maven repository.
